...
function validation() {
    ...
    if (idValue === "") {
        ...
        idGroup.classList.add("has-success");  // ✅ 올바른 값이면 성공 클래스 추가
    }
    ...
    if (passwordValue === "") {
        ...
        passwordGroup.classList.add("has-success");  // ✅ 올바른 값이면 성공 클래스 추가
    }
    ...
    return isValid;
		...
		if(validation() == false) return false;
			$.ajax({
				...
				,data : { "urID" : $("#urID").val(), "urPassword" : $("#urPassword").val(), "autoLogin" : $("#autoLogin").is(":checked")}
